...
namespace DiChoSaiGon.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public CheckoutController(MarketsContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Success()
        {
            try
            {
                ...
                successVM.PhuongXa = GetNameLocation(donhang.Ward);
                successVM.TinhThanh = GetNameLocation(donhang.District);

...
namespace DiChoSaiGon.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(MarketsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var collection = _context.Accounts.AsNoTracking().ToList();
            ...
            var marketsContext = _context.Accounts.Include(a => a.Role);
            return View(await marketsContext.ToListAsync());
        }
